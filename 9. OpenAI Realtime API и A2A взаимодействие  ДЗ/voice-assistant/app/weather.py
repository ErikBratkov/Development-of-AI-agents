...
def format_weather_report(place: dict[str, Any], current: dict[str, Any]) -> str:
...
# реестр инструментов для LLM клиента, при добавлении нового
# инструмента достаточно дописать его сюда
TOOLS_SPEC: list[dict[str, Any]] = [WEATHER_TOOL_SPEC]
TOOL_HANDLERS: dict[str, Any] = {"get_weather": get_weather}
